...
=            Section services            =
=============================================*/
monApp.service('contactService',['$http',function($http){
	...
	{id:9,name:'Jhonson',email:"Jhonson@email.com",img:'img9.jpg',img_header:'img9.jpg',
	   ...
	   {id:11,name:'damir',email:"dami@email.com",img:'img11.jpg',img_header:'img10.jpeg',
       social:{
       	twitter:"",
       	linkedin:"",
       	codepen:"",
	   ...
	   {id:12,name:'fridiric',email:"fred@email.com",img:'img12.jpg',img_header:'img10.jpeg',
       social:{
       	twitter:"",
       	linkedin:"",
       	codepen:"",
	   ...
	   {id:13,name:'irick',email:"irick@email.com",img:'img13.jpg',img_header:'img10.jpeg',
       social:{
       	twitter:"",
       	linkedin:"",
       	codepen:"",
	   ...
	   {id:14,name:'dolso',email:"dolso@email.com",img:'img14.jpg',img_header:'img10.jpeg',
       social:{
       	twitter:"",
       	linkedin:"",
       	codepen:"",
	   ...
	   {id:15,name:'miki',email:"miki@email.com",img:'img15.jpg',img_header:'img10.jpeg',
       social:{
       	twitter:"",
       	linkedin:"",
       	codepen:"",
	   ...
	   {id:16,name:'ziki',email:"ziki@email.com",img:'img16.jpg',img_header:'img10.jpeg',
       social:{
       	twitter:"",
       	linkedin:"",
       	codepen:"",
	   ...
	   {id:15,name:'eiki',email:"eiki@email.com",img:'img17.jpg',img_header:'img10.jpeg',
       social:{
       	twitter:"",
       	linkedin:"",
       	codepen:"",
	   ...
	   {id:18,name:'ivana',email:"ivan@email.com",img:'img18.jpg',img_header:'img10.jpeg',
       social:{
       	twitter:"",
       	linkedin:"",
       	codepen:"",
	   ...
	   {id:19,name:'joseph',email:"miki@email.com",img:'img19.jpg',img_header:'img10.jpeg',
       social:{
       	twitter:"",
       	linkedin:"",
       	codepen:"",
	   ...
	   {id:20,name:'miki',email:"miki@email.com",img:'img20.jpg',img_header:'img10.jpeg',
       social:{
       	twitter:"",
       	linkedin:"",
       	codepen:"",
	...
	this.get_Contact = function(id){
		return self.contacts_list[id-1]
	}
...
monApp.controller('mainController',['$http','$scope','contactService','$location',function($http,$scope,contactService,$location){
...
monApp.controller('contactController',['$scope','$routeParams','contactService',function($scope,$routeParams,contactService){
      ...
      $scope.contactInfo = contactService.get_Contact($routeParams.id);
